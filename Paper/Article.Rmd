...
This analysis aims to inform the general public and cyclists about
Toronto’s bike theft hotspots, highlighting neighborhoods with the
highest rate of thefts and times when bikes are most at risk. It would
not only raise awareness but also help general public and Toronto police
take proactive measures to secure bikes, ultimately reducing the risk of
theft and fostering a safer cycling environment in Toronto.

### Bicycle Theft over time: Tracking trends in top 10 neighborhoods
...
bike_thefts %>%
  ...
  geom_point(size = 3) +
  labs(title = "Total Bike Thefts in Top 10 Neighborhoods (2019-2023)",
...
bike_thefts %>%
  ...
  labs(caption = "Bike Thefts by Month of the Year",
